      ...
      },
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "They deploy them for high-volume, rules-based tasks that require cognitive flexibility—like customer support triaging, invoice reconciliation, data entry, and personalized outreach."
            }
          },
          {
            "@type": "Question",
            ...
            <div className="space-y-4">
              <Card className="bg-card border-none shadow-sm">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">A chatbot waits for a prompt and returns text. An agentic system is given a goal (e.g., "process this invoice"), plans the steps, uses tools to execute them, and verifies its own work.</p>
                </CardContent>
              </Card>
              <Card className="bg-card border-none shadow-sm">
                <CardContent className="p-6">
